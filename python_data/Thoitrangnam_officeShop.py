...
product_item = []
for i in range(0, 1):
    response = requests.get('https://shopee.vn/api/v4/official_shop/get_shops?category_id=11035567&limit=23&offset=0')
...
with open('Thoitrangnam_officeShops.json', 'w') as file:
