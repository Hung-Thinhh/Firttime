    ...
    function Validate(inputElement, rule){
        ...
        if(errorMessage){
            ...
            btn_login.onclick = function(e){
                e.preventDefault();
                form_password.classList.remove('displayed')
                document.querySelector('#phone-number').classList.add('displayed')
                if(!form_password.classList.contains('displayed')){
                    btn_login.innerHTML = 'Xác nhận';
                    btn_login.classList.add('submid')
                    form_password.parentElement.classList.remove('displayed')
                    form_phoneNumber.parentElement.classList.add('displayed')
                    
                }
                
            }
            document.querySelector('.submid').onclick = function(e){
                e.preventDefault();
