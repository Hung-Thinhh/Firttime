...
for (const element of category) {
    element.onclick = function (e) {
        ...
        const id = element.id
        console.log(id)
        window.location.href = `/Thoi-Trang-Nam?catid=${id}&page=1`;
...
const product = document.querySelector('.container__main-category-recommed-panels-item-a')
console.log(product.parentElement.getAttribute('id'))
