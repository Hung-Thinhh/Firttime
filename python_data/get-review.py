...
for i in range(0,1):
    a+=1
    response = requests.get('https://shopee.vn/api/v2/item/get_ratings?filter=0&flag=1&itemid=20972490711&limit=6&offset=0&shopid=947257509&type=0')#, cookies=cookies)
    if response.status_code == 200:
        print('request success!!!')
        product_item.append({'page{}'.format(a):response.json()})
