...
headers = {
    ...
    'Referer': 'https://shopee.vn/Th%E1%BB%9Di-Trang-Nam-cat.11035567?page=8',
...
product_item = []
for i in range(0, 1):
    response = requests.get('https://shopee.vn/api/v4/pages/get_popular_collection?catid=11035567')
...
with open('Thoitrangnam_popular.json', 'w') as file:
